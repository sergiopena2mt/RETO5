...
public class ReservationControlador {
    ...
    @GetMapping("/report-dates/{fechaIni}/{fechaFin}")
     public List<Reservation> getReservationTime (@PathVariable("fechaIni")String fecha1, @PathVariable("fechaFin")String fecha2 ){
         return reservationServicio.reportTimeServicio(fecha1, fecha2);
     }
     
     @GetMapping("/report-clients")
     public List<ContadorClient> getClient(){
         return reservationServicio.reporteClientServicio();
     }
}
